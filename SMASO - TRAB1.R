...
#Produção sector agricola dominado apenas por um agente, sem produção pelos outros dois agentes
prod <- data.frame(
Agriculture=c(84,rep(0,11)), Clothing=c(rep(0,3),rep(0.4616,3),rep(0,6)),
Transportation=c(rep(0,6),rep(0.015384,3),rep(0,3)), Health=c(rep(0,9),rep(5.52,3)),
Money=rep(0,12)
)
